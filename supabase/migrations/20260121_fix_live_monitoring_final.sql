-- Fix Live Monitoring RPC - Final Working Version
-- Uses telecaller_id (UUID) instead of assigned_employee_id (TEXT)
...
BEGIN
  ...
  -- Use telecaller_id (UUID) instead of assigned_employee_id (TEXT)
