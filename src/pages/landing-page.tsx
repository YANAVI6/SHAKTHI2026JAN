    ...
    <div className="min-h-screen bg-white selection:bg-sky-500/20 selection:text-sky-600 relative overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button size="lg" className="bg-white text-indigo-600 hover:bg-gray-50 text-lg px-10 h-16 rounded-2xl shadow-xl shadow-black/10 font-bold transition-transform hover:-translate-y-1">
                Get Started Now
              </Button>
              <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 hover:text-white text-lg px-10 h-16 rounded-2xl backdrop-blur-sm">
                Schedule Demo
              </Button>
            </div>
          </motion.div>
      ...
      <div className="fixed bottom-6 left-4 right-4 z-50 md:hidden">
        <motion.div
          ...
          transition={{ delay: 2 }}
        >
          <Button className="w-full h-14 bg-indigo-600 text-white rounded-2xl shadow-2xl font-bold text-lg border-2 border-white/20">
            Start Free – ₹10/Day
          </Button>
        </motion.div>
      </div>
      ...
      <div className="fixed bottom-10 right-10 z-40 hidden lg:block">
        ...
        >
          ...
          <div className="relative px-6 py-4 bg-white ring-1 ring-gray-900/5 rounded-3xl leading-none flex items-center gap-4 shadow-2xl">
            ...
            <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl px-4">
              Get Started
            </Button>
          </div>
        </motion.div>
