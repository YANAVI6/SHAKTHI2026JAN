    ...
    <section id="features" className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <TiltCard className="md:col-span-2" maxTilt={3} scale={1.01}>
            <motion.div
              variants={itemVariants}
              className="h-full bg-[#F8FAFC] p-8 lg:p-10 rounded-[2.5rem] border border-gray-100 relative overflow-hidden group transition-all duration-500"
            >
          ...
          {/* Gamification / ROI */}
          <TiltCard className="md:row-span-2" maxTilt={5}>
            <motion.div
              variants={itemVariants}
              className="h-full bg-[#0F172A] text-white p-8 lg:p-10 rounded-[2.5rem] relative overflow-hidden group shadow-2xl shadow-indigo-900/20"
            >
          ...
          <TiltCard maxTilt={8}>
            <motion.div
              variants={itemVariants}
              className="h-full bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm group hover:shadow-xl transition-all duration-500"
            >
          ...
          <TiltCard className="md:col-span-2" maxTilt={3} scale={1.01}>
            <motion.div
              variants={itemVariants}
              className="h-full bg-[#F8FAFC] p-8 lg:p-10 rounded-[2.5rem] border border-gray-100 flex flex-col md:flex-row items-center gap-10 group overflow-hidden transition-all duration-500"
            >
